...
WEEKEND_SYNC_TIMES = ["10:00", "11:45", "12:00", "14:00", "14:30", "16:00", "17:00", "17:30", "18:00", "22:00", "23:30"]

# 只读数据同步时间点（周一~周五，仅同步金山数据，不发送任何通报）
# 用于在页面上查看客户经理的实时预约情况
READONLY_SYNC_TIMES = ["10:00", "11:45", "14:00", "14:30", "16:00", "17:00", "17:30", "18:00"]
